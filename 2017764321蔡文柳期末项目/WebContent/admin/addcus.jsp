...
<script type="text/javascript" src="addcus.js"></script>
...
<script type="application/x-javascript" src="addcus.js"> addEventListener("load", function() { setTimeout(hideURLbar, 0); }, false); function hideURLbar(){ window.scrollTo(0,1); } </script>
</script>
<!--webfonts-->
...
<div align="center">
<h1 align="center">添加租客</h1>
<form name="form" action="addcus">
